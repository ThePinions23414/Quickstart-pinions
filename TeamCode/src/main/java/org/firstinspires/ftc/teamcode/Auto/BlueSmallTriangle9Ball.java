...
@Autonomous
public class BlueSmallTriangle9Ball extends OpMode {
    ...
    private final Pose pick2Pose = new Pose(15.18419, 59.20268438143005, Math.toRadians(180));
    ...
    private PathChain driveStartPosShoot1Pos, driveShoot1PosBall1Pos, driveBall1PosPick1Pos, drivePick1PosShoot2Pos, driveShoot2PosBall2Pos, driveBall2PosPick2Pos, drivePick2PosShoot3Pos, driveShoot3PosEndPos;
