...
@Autonomous
public class RedGoal12BallGateOpen extends OpMode {
    ...
    public enum PathState {
        ...
        DRIVE_BACKUP_GATEOPENPOS,
        DRIVE_GATEOPENPOS_BACKUPOPEN,
        DRIVE_BACKUPOPEN_SHOOT2POS,
        SHOOT_PRELOAD2,
    ...
    private final Pose startPose = new Pose(123.75002, 121.927644166881, Math.toRadians(36.5));
    private final Pose shoot1Pose = new Pose(96.15808, 95.8023690459329, Math.toRadians(43.5));
    private final Pose ball1Pose = new Pose(99.03292, 60.26978997878086, Math.toRadians(0));
    private final Pose pick1Pose = new Pose(129.81581, 60.20268438143005, Math.toRadians(0));
    private final Pose backUp = new Pose(115, 60.20268438143005, Math.toRadians(0));
    private final Pose gateOpenPos = new Pose(124.99344, 64.63820390196331, Math.toRadians(0));
    private final Pose backUpOpen = new Pose(105, 60.20268438143005, Math.toRadians(0));
    private final Pose shoot2Pose = new Pose(96.15808, 95.8023690459329, Math.toRadians(42.5));
    private final Pose gatePose = new Pose(124.99344, 64.63820390196331, Math.toRadians(0));
    private final Pose gateLineUpPose = new Pose(105, 64.63820390196331, Math.toRadians(0));
    private final Pose rampPose = new Pose(130.4888888888889,57.6, Math.toRadians(45));
    private final Pose backUp2 = new Pose(100,57.6, Math.toRadians(42.5));
    private final Pose shoot3Pose = new Pose(96.15808, 95.8023690459329, Math.toRadians(42.5));
    private final Pose gatePose2 = new Pose(122.99344, 64.63820390196331, Math.toRadians(0));
    private final Pose gateLineUpPose2 = new Pose(105, 64.63820390196331, Math.toRadians(0));
    private final Pose rampPose2 = new Pose(130.4888888888889, 57.6, Math.toRadians(45));
    private final Pose backUp3 = new Pose(100, 57.6, Math.toRadians(0));
    private final Pose shoot4Pose = new Pose(96.15808, 95.8023690459329, Math.toRadians(42.5));
    private final Pose ball4Pose = new Pose(98.01319, 84, Math.toRadians(0));
    private final Pose pick4Pose = new Pose(117.99344, 84, Math.toRadians(0));
    private final Pose shoot5Pose = new Pose(96.15808, 95.8023690459329, Math.toRadians(42.5));
    private final Pose endPose = new Pose(115.66449, 64.63820390196331, Math.toRadians(0));




    private PathChain driveStartPosShoot1Pos, driveShoot1PosBall1Pos, driveBall1PosPick1Pos, drivePick1PosBackUp, driveBackUpGateOpenPos, driveGateOpenPosBackUpOpen, driveBackUpOpenShoot2Pos, driveShoot2PosGateLineUpPos, driveGateLineUpPosGatePos, driveGatePosRampPos, driveRampPosBackUp2, driveBackUp2Shoot3Pos, driveShoot3PosGateLineUpPos2, driveGateLineUpPos2GatePos2, driveGatePos2RampPos2, driveRampPos2BackUp3, driveBackUp3Shoot4Pos, driveShoot4PosBall4Pos, driveBall4PosPick4Pos, drivePick4PosShoot5Pos, driveShoot5PosEndPos;
    ...
    public void buildPaths() {
        ...
        drivePick1PosBackUp = follower.pathBuilder()
                ...
                .build();
        driveBackUpGateOpenPos = follower.pathBuilder()
                .addPath(new BezierLine(backUp, gateOpenPos))
                .setLinearHeadingInterpolation(backUp.getHeading(), gateOpenPos.getHeading())
                .build();
        driveGateOpenPosBackUpOpen = follower.pathBuilder()
                .addPath(new BezierLine(gateOpenPos, backUpOpen))
                .setLinearHeadingInterpolation(gateOpenPos.getHeading(), backUpOpen.getHeading())
                .build();
        driveBackUpOpenShoot2Pos = follower.pathBuilder()
                .addPath(new BezierLine(backUpOpen, shoot2Pose))
                .setLinearHeadingInterpolation(backUpOpen.getHeading(), shoot2Pose.getHeading())
                .build();
        ...
        switch(pathState) {
            ...
            case DRIVE_PICK1POS_BACKUP:
                if(!follower.isBusy()){
                    ...
                    setPathState(PathState.DRIVE_BACKUP_GATEOPENPOS);
                }

                break;
            case DRIVE_BACKUP_GATEOPENPOS:
                if(!follower.isBusy()){
                    follower.followPath(driveBackUpGateOpenPos, true);
                    setPathState(PathState.DRIVE_GATEOPENPOS_BACKUPOPEN);
                }

                break;
            case DRIVE_GATEOPENPOS_BACKUPOPEN:
                if(!follower.isBusy()){
                    follower.followPath(driveGateOpenPosBackUpOpen, true);
                    setPathState(PathState.DRIVE_BACKUPOPEN_SHOOT2POS);
                }

                break;
            case DRIVE_BACKUPOPEN_SHOOT2POS:
                if(!follower.isBusy()){
                    follower.followPath(driveBackUpOpenShoot2Pos, true);
