...
@TeleOp(name = "BLUE_Decode_TeleOp_DEMO")
public class BLUE_Decode_TeleOp_DEMO extends LinearOpMode {
...
//            }
            ...
            if (result.isValid()) {
                ...
                else if(result.getTx() > -2 && result.getTx() < 3.5){
