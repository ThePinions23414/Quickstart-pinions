...
@Autonomous
public class BlueGoal12BallGateOpen extends OpMode {
    ...
    private final Pose backUp = new Pose(29, 60.20268438143005, Math.toRadians(180));
    private final Pose gateOpenPos = new Pose(19.00656, 64.63820390196331, Math.toRadians(180));
    private final Pose backUpOpen = new Pose(39, 60.20268438143005, Math.toRadians(180));
    private final Pose shoot2Pose = new Pose(47.84192, 95.8023690459329, Math.toRadians(137.5));
    private final Pose gatePose = new Pose(19.00656, 64.63820390196331, Math.toRadians(180));
