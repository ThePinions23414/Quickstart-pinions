...
public class RedSmallTriangle extends OpMode {
    ...
    private final Pose startPose = new Pose(80.36, 8.177777777777768, Math.toRadians(90));
    private final Pose shoot1Pose = new Pose(84.45, 12.177777777777763, Math.toRadians(63));
    ...
    private final Pose shoot2Pose = new Pose(84.45, 12.177777777777763, Math.toRadians(63));
    ...
    private final Pose shoot3Pose = new Pose(84.45, 12.177777777777763, Math.toRadians(63));
