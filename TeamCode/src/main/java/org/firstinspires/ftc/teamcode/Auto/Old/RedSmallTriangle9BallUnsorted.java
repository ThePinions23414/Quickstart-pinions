...
import org.firstinspires.ftc.teamcode.Auto.FlywheelLogicSmallTriangle;
import org.firstinspires.ftc.teamcode.Auto.RedSmallTriangle9BallSorted;
import org.firstinspires.ftc.teamcode.pedroPathing.Constants;

public class RedSmallTriangle9BallUnsorted extends OpMode {
    ...
    RedSmallTriangle9BallSorted.PathState pathState;

    private final Pose startPose = new Pose(88.0025, 8.177777777777768, Math.toRadians(90));
    private final Pose shoot1Pose = new Pose(84.45, 12.177777777777763, Math.toRadians(68));
    private final Pose ball1Pose = new Pose(99.45, 35.37777777777776, Math.toRadians(0));
    private final Pose pick1Pose = new Pose(135.74, 35.688888888888876, Math.toRadians(0));
    private final Pose shoot2Pose = new Pose(84.45, 12.177777777777763, Math.toRadians(68));
    private final Pose ball2Pose = new Pose(99.45, 59.26978997878086, Math.toRadians(0));
    private final Pose pick2Pose = new Pose(132.5, 59.26978997878086, Math.toRadians(0));
    private final Pose shoot3Pose = new Pose(84.45, 12.177777777777763, Math.toRadians(68));
    ...
    public void statePathUpdate() {
        switch(pathState) {
            case DRIVE_STARTPOS_SHOOT1POS:
                ...
                setPathState(RedSmallTriangle9BallSorted.PathState.SHOOT_PRELOAD1);
                break;
            case SHOOT_PRELOAD1:
                if (!follower.isBusy()) {
                    if (!shotsTriggered) {
                        ...
                        setPathState(RedSmallTriangle9BallSorted.PathState.DRIVE_SHOOT1POS_BALL1POS);
                    }
                }
                break;
            case DRIVE_SHOOT1POS_BALL1POS:
                if(!follower.isBusy()){
                    ...
                    setPathState(RedSmallTriangle9BallSorted.PathState.DRIVE_BALL1POS_PICK1POS);
                }
            ...
            case DRIVE_BALL1POS_PICK1POS:
                ...
                if(!follower.isBusy()){
                    ...
                    setPathState(RedSmallTriangle9BallSorted.PathState.DRIVE_PICK1POS_SHOOT2POS);
                }
                break;
            case DRIVE_PICK1POS_SHOOT2POS:
                if(!follower.isBusy()){
                    follower.followPath(drivePick1PosShoot2Pos, true);
                    setPathState(RedSmallTriangle9BallSorted.PathState.SHOOT_PRELOAD2);
                }
            ...
            case SHOOT_PRELOAD2:
                if (!follower.isBusy() && !intake.isStillGoing()) {
                    if (!shotsTriggered) {
                        ...
                        setPathState(RedSmallTriangle9BallSorted.PathState.DRIVE_SHOOT2POS_BALL2POS);
                    }
                }
                break;
            case DRIVE_SHOOT2POS_BALL2POS:
                if (!follower.isBusy()) {
                    ...
                    setPathState(RedSmallTriangle9BallSorted.PathState.DRIVE_BALL2POS_PICK2POS);
                }
                break;
            case DRIVE_BALL2POS_PICK2POS:
                ...
                if (!follower.isBusy()) {
                    ...
                    setPathState(RedSmallTriangle9BallSorted.PathState.DRIVE_PICK2POS_SHOOT3POS);
                }
                break;
            case DRIVE_PICK2POS_SHOOT3POS:
                if(!follower.isBusy()){
                    follower.followPath(drivePick2Shoot3, true);
                    setPathState(RedSmallTriangle9BallSorted.PathState.SHOOT_PRELOAD3);
                }
                break;
    ...
    public void setPathState(RedSmallTriangle9BallSorted.PathState newState) {
        pathState = newState;
    ...
    @Override
    public void init(){
        pathState = RedSmallTriangle9BallSorted.PathState.DRIVE_STARTPOS_SHOOT1POS;
        pathTimer = new Timer();
