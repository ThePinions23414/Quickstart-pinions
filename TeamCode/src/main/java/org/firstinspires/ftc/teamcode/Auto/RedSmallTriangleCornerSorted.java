...
@Autonomous
public class RedSmallTriangleCornerSorted extends OpMode {
    private Follower follower;
    private Timer pathTimer, opModeTimer;

    private FlywheelLogicSmallTriangle shooter = new FlywheelLogicSmallTriangle();
    private IntakeLogicSTCorner intake = new IntakeLogicSTCorner();
    ...
    private final Pose pick1Pose = new Pose(135.26339, 35.21635311143271, Math.toRadians(0));
    private final Pose shoot2Pose = new Pose(88.44445, 12.177777777777763, Math.toRadians(65));
    private final Pose ball2Pose = new Pose(133, 16.488888888888887, Math.toRadians(340));
    private final Pose ball2Pose2 = new Pose(122, 16.333333333333334, Math.toRadians(340));
    private final Pose ball2Pose3 = new Pose(133, 9.955555555555568, Math.toRadians(335));
