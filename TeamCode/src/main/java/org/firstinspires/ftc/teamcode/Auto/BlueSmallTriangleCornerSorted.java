...
@Autonomous
public class BlueSmallTriangleCornerSorted extends OpMode {
    ...
    private final Pose pick1Pose = new Pose(8.73661, 35.21635311143271, Math.toRadians(180));
    private final Pose shoot2Pose = new Pose(55.55555, 12.177777777777763, Math.toRadians(115));
    private final Pose ball2Pose = new Pose(11, 16.488888888888887, Math.toRadians(200));
    private final Pose ball2Pose2 = new Pose(22, 16.333333333333334, Math.toRadians(200));
    private final Pose ball2Pose3 = new Pose(11, 9.955555555555568, Math.toRadians(205));
