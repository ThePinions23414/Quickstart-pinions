...
@Autonomous
public class RedSmallTriangleCorner15 extends OpMode {
    ...
    private final Pose cornerPose1 = new Pose(132, 13, Math.toRadians(335));
    private final Pose cornerPose2 = new Pose(120, 16.333333333333334, Math.toRadians(345));
    private final Pose cornerPose3 = new Pose(132, 25, Math.toRadians(345));
    private final Pose shoot3Pose = new Pose(88.44445, 12.177777777777763, Math.toRadians(63));
    private final Pose corner2Pose1 = new Pose(132, 13, Math.toRadians(335));
    private final Pose corner2Pose2 = new Pose(120, 16.333333333333334, Math.toRadians(345));
    private final Pose corner2Pose3 = new Pose(132, 25, Math.toRadians(345));
    private final Pose shoot4Pose = new Pose(88.44445, 12.177777777777763, Math.toRadians(63));
    private final Pose corner3Pose1 = new Pose(132, 13, Math.toRadians(335));
    private final Pose corner3Pose2 = new Pose(120, 16.333333333333334, Math.toRadians(345));
    private final Pose corner3Pose3 = new Pose(132, 25, Math.toRadians(345));
    private final Pose shoot5Pose = new Pose(88.44445, 12.177777777777763, Math.toRadians(63));
